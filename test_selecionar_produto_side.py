...
class TestSelecionarProduto():
  def setup_method(self, method):
    ...
    self.vars = {}
    self.driver.implicitly_wait(5)  # irá esperar qualquer elemento aparecer na tela por até 5 segundos.
  ...
  def test_selecionarProduto(self):
    ...
    self.driver.set_window_size(1827, 990)
    ...
    # time.sleep(1) # parando o processamento / thread por 2 segundos (não 'recomendado', uso temporário)    
